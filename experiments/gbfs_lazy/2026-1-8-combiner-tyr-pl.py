...
def rename(run):
    if run["algorithm"] == "gbfs-lazy-hff-pref-ff-8":
        run["algorithm"] = "gbfs-lazy-hff-pref-ff-8-1024"
        run["id"][0] = "gbfs-lazy-hff-pref-ff-8-1024"
    return True

def normalize_rename_htg(run):
    if not normalize_htg(run):
        return False
    rename(run)
    return True
    
def normalize_rename_autoscale(run):
    if not normalize_autoscale(run):
        return False
    rename(run)
    return True

def normalize_rename(run):
    if not normalize(run):
        return False
    rename(run)
    return True
...
exp_htg.add_fetcher("results_raw/tyr-2026-1-8-gbfs_lazy-combined-eval", filter=normalize_htg)
exp_htg.add_fetcher("results_raw/tyr-2-2026-1-8-gbfs_lazy-8-eval", filter=normalize_rename_htg)
exp_htg.add_fetcher("results_raw/fd-2026-2-28-gbfs-lazy-ff-pref-ff-eval", filter=normalize_htg)
exp_htg.add_report(BaseReport(attributes=ATTRIBUTES, filter_algorithm=["downward-gbfs-lazy-hff-pref-ff", "powerlifted-gbfs-lazy-hff-pref-ff", "gbfs-lazy-hff-pref-ff-1", "gbfs-lazy-hff-pref-ff-2", "gbfs-lazy-hff-pref-ff-4", "gbfs-lazy-hff-pref-ff-8", "gbfs-lazy-hff-pref-ff-8-1024"]))
exp_htg.run_steps()
...
exp_autoscale.add_fetcher("results_raw/tyr-2026-1-8-gbfs_lazy-combined-eval", filter=normalize_autoscale)
exp_autoscale.add_fetcher("results_raw/tyr-2-2026-1-8-gbfs_lazy-8-eval", filter=normalize_rename_autoscale)
exp_autoscale.add_fetcher("results_raw/fd-2026-2-28-gbfs-lazy-ff-pref-ff-eval", filter=normalize_autoscale)
exp_autoscale.add_report(BaseReport(attributes=ATTRIBUTES, filter_algorithm=["downward-gbfs-lazy-hff-pref-ff", "powerlifted-gbfs-lazy-hff-pref-ff", "gbfs-lazy-hff-pref-ff-1", "gbfs-lazy-hff-pref-ff-2", "gbfs-lazy-hff-pref-ff-4", "gbfs-lazy-hff-pref-ff-8", "gbfs-lazy-hff-pref-ff-8-1024"]))
...
exp.add_fetcher("results_raw/tyr-2026-1-8-gbfs_lazy-combined-eval", filter=normalize)
exp.add_fetcher("results_raw/tyr-2-2026-1-8-gbfs_lazy-8-eval", filter=normalize_rename)
exp.add_fetcher("results_raw/fd-2026-2-28-gbfs-lazy-ff-pref-ff-eval", filter=normalize)
exp.add_report(BaseReport(attributes=ATTRIBUTES, filter_algorithm=["downward-gbfs-lazy-hff-pref-ff", "powerlifted-gbfs-lazy-hff-pref-ff", "gbfs-lazy-hff-pref-ff-1", "gbfs-lazy-hff-pref-ff-2", "gbfs-lazy-hff-pref-ff-4", "gbfs-lazy-hff-pref-ff-8", "gbfs-lazy-hff-pref-ff-8-1024"]))
exp.run_steps()