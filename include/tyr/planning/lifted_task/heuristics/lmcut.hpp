...
#ifndef TYR_PLANNING_LIFTED_TASK_HEURISTICS_LMCUT_HPP_
#define TYR_PLANNING_LIFTED_TASK_HEURISTICS_LMCUT_HPP_
...
class LMCutHeuristic<LiftedTag> :
    public RPGBase<LMCutHeuristic<LiftedTag>,
                   datalog::OrAnnotationPolicy,
                   datalog::AchieverAndAnnotationPolicy<datalog::MaxAggregation>,
                   datalog::TerminationPolicy<datalog::MaxAggregation>,
                   datalog::RuleBindingCostOverridePolicy>
{
public:
    using Base = RPGBase<LMCutHeuristic<LiftedTag>,
                         datalog::OrAnnotationPolicy,
                         datalog::AchieverAndAnnotationPolicy<datalog::MaxAggregation>,
                         datalog::TerminationPolicy<datalog::MaxAggregation>,
                         datalog::RuleBindingCostOverridePolicy>;
