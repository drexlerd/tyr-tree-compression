...
class View<ygg::Index<::tyr::formalism::Predicate<T>>, C>
{
private:
    const C* m_context;
    ygg::Index<::tyr::formalism::Predicate<T>> m_handle;

public:
    View(ygg::Index<::tyr::formalism::Predicate<T>> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
