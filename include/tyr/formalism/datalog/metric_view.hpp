...
class View<ygg::Index<::tyr::formalism::datalog::Metric>, C>
{
private:
    const C* m_context;
    ygg::Index<::tyr::formalism::datalog::Metric> m_handle;

public:
    View(ygg::Index<::tyr::formalism::datalog::Metric> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
