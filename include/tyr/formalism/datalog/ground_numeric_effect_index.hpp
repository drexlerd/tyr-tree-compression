...
struct Index<tyr::formalism::datalog::GroundNumericEffect<Op, T>> : ygg::IndexMixin<ygg::Index<tyr::formalism::datalog::GroundNumericEffect<Op, T>>>
{
    ...
    using Base = ygg::IndexMixin<ygg::Index<tyr::formalism::datalog::GroundNumericEffect<Op, T>>>;
    using Base::Base;
};
