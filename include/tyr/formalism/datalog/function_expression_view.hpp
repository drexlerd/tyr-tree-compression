...
class View<ygg::Data<::tyr::formalism::datalog::FunctionExpression>, C>
{
private:
    const C* m_context;
    ygg::Data<::tyr::formalism::datalog::FunctionExpression> m_handle;

public:
    View(ygg::Data<::tyr::formalism::datalog::FunctionExpression> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
...
template<typename C>
auto make_view(const ygg::Data<::tyr::formalism::datalog::FunctionExpression>& element, const C& context) noexcept
{
    return ygg::View<ygg::Data<::tyr::formalism::datalog::FunctionExpression>, C>(element,
                                                                 std::visit(
