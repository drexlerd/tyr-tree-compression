...
private:
    const C* m_context;
    ygg::Index<::tyr::formalism::datalog::GroundFunctionTerm<T>> m_handle;

public:
    View(ygg::Index<::tyr::formalism::datalog::GroundFunctionTerm<T>> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
