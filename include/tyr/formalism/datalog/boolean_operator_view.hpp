...
private:
    const C* m_context;
    ygg::Data<::tyr::formalism::datalog::BooleanOperator<T>> m_handle;

public:
    View(ygg::Data<::tyr::formalism::datalog::BooleanOperator<T>> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
