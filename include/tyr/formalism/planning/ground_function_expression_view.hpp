...
class View<ygg::Data<::tyr::formalism::planning::GroundFunctionExpression>, C>
{
private:
    const C* m_context;
    ygg::Data<::tyr::formalism::planning::GroundFunctionExpression> m_handle;

public:
    View(ygg::Data<::tyr::formalism::planning::GroundFunctionExpression> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
...
template<typename C>
auto make_view(const ygg::Data<::tyr::formalism::planning::GroundFunctionExpression>& element, const C& context) noexcept
{
    return ygg::View<ygg::Data<::tyr::formalism::planning::GroundFunctionExpression>, C>(element,
                                                                        std::visit(
