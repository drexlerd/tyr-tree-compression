...
class View<ygg::Index<::tyr::formalism::planning::Atom<T>>, C>
{
private:
    const C* m_context;
    ygg::Index<::tyr::formalism::planning::Atom<T>> m_handle;

public:
    View(ygg::Index<::tyr::formalism::planning::Atom<T>> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
