...
class View<ygg::Data<::tyr::formalism::planning::ArithmeticOperator<T>>, C>
{
private:
    const C* m_context;
    ygg::Data<::tyr::formalism::planning::ArithmeticOperator<T>> m_handle;

public:
    View(ygg::Data<::tyr::formalism::planning::ArithmeticOperator<T>> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
...
auto make_view(const ygg::Data<::tyr::formalism::planning::ArithmeticOperator<T>>& element, const C& context) noexcept
{
    return ygg::View<ygg::Data<::tyr::formalism::planning::ArithmeticOperator<T>>, C>(
        element,
