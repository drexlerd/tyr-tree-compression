...
class View<ygg::Index<::tyr::formalism::planning::GroundConjunctiveCondition>, C>
{
private:
    const C* m_context;
    ygg::Index<::tyr::formalism::planning::GroundConjunctiveCondition> m_handle;

public:
    View(ygg::Index<::tyr::formalism::planning::GroundConjunctiveCondition> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
