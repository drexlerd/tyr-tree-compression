...
private:
    const C* m_context;
    ygg::Data<::tyr::formalism::planning::NumericEffectOperator<T>> m_handle;

public:
    View(ygg::Data<::tyr::formalism::planning::NumericEffectOperator<T>> data, const C& context) noexcept : m_context(&context), m_handle(data) {}
...
auto make_view(const ygg::Data<::tyr::formalism::planning::NumericEffectOperator<T>>& element, const C& context) noexcept
{
    return ygg::View<ygg::Data<::tyr::formalism::planning::NumericEffectOperator<T>>, C>(
        element,
