...
private:
    const C* m_context;
    ygg::Index<::tyr::formalism::planning::GroundAction> m_handle;

public:
    View(ygg::Index<::tyr::formalism::planning::GroundAction> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
