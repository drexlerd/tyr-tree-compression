...
TEST(TyrTests, TyrCommonUniqueObjectPoolReportsStorageSize)
{
    auto pool = UniqueObjectPool<UniquePoolValue>();
...
TEST(TyrTests, TyrCommonThreadSafeUniqueObjectPoolReportsStorageSize)
{
    auto pool = UniqueObjectPool<UniquePoolValue, true>();
