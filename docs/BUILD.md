...
```console
uv venv
uv pip install 'pyyggdrasil>=0.0.21,<0.1' 'pypddl>=1.0.23,<1.1' 'pypddl-datasets>=0.0.7,<0.1'
```
...
.venv/bin/python -m pip install 'pyyggdrasil>=0.0.21,<0.1' 'pypddl>=1.0.23,<1.1' 'pypddl-datasets>=0.0.7,<0.1'
```
